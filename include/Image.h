#ifndef SIMPLE_LIB_IMAGE
#define SIMPLE_LIB_IMAGE
...
public:
	...
	ColorImage(const ColorImage &other) : data(other.data), width(other.width), height(other.height) {}
...
public:
	...
	GrayscaleImage(const GrayscaleImage &other) : data(other.data), width(other.width), height(other.height) {}
